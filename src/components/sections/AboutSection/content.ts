...
export const content = [
  {
    ...
    longDescription:
      'Pracuje w nurcie Terapii Skoncentrowanej na Rozwiązaniach (ukończony całościowych kurs I i II stopnia), wykorzystując wiedzę z zakresu dialogu motywującego i terapii poznawczo – behawioralnej. Obecnie uczestniczy w 4 – letnim kursie psychoterapii poznawczo – behawioralnej. Stale swoją pracę poddaje superwizji. Pracownik naukowo – dydaktyczny Instytutu Pedagogiki Akademii Pomorskiej w Słupsku. Psycholog szkolny w I Liceum Ogólnokształcącym im. Bolesława Krzywoustego w Słupsku. W latach 2011 – 2019 pracownik Ośrodka Doskonalenia Nauczycieli w Słupsku.',
    scienceTitle: ['Socjolog', 'Psycholog'],
  },
  {
    name: 'Monika Walczak',
    shortDescription:
    ...
    scienceTitle: ['Psycholog', 'Diagnosta', 'Terapeuta dzieci i młodzieży'],
  },
];
