...
export const content = [
  {
    ...
    aboutTexts: [
      {
        text: 'Pracownik naukowo – dydaktyczny Instytutu Pedagogiki Akademii Pomorskiej w Słupsku. Psycholog szkolny w I Liceum Ogólnokształcącym im. Bolesława Krzywoustego w Słupsku. W latach 2011 – 2019 pracownik Ośrodka Doskonalenia Nauczycieli w Słupsku.',
      },
      {
        title: 'Usługi',
